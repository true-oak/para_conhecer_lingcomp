## OBJETIVO: implementar um classificador bayesiano ingenuo q classifica se um e-mail é spam ou não.
# treinamento (aprendizagem supervisionada) -> fixar parâmetros.
# os parâmetros são são a [contagem de classes] e de atributos (palavras) das mensagens.
